...
RealTech-Hackathon is an AI-powered property recommendation engine designed to provide highly personalised area recommendations for UK property seekers. The system employs a unique 3-layer architecture that separates high-level directives from intelligent orchestration and deterministic execution scripts. By synthesising data from property intelligence, transport, crime, and education sources, it delivers ranked recommendations with natural language explanations and AI-generated video summaries.
